...
are non-negative), you can at least that that $f(x) \ge 2$
...
$$
f'(x) > 0 \iff \left( \frac 1 e , 1\right) \cup (e,\infty)
$$
...
<div class="center">
<figure>
<img src={rough_graph_f.src} alt="Rough sketch of f without considering curvature" width="500" height="auto" />
...
then $r(0) = 1$, $r(-1) = -4$. Ah! By the polynomial
...
<div class="center">
<figure>
<img src={graph_h.src} alt="Rough Graph of function h" width="500" height="auto" />
...
<figure>
<img src={graphImg.src} alt="Graph" width="500" height="auto" />
...
<div class="center" style="padding-bottom: 1rem">
<figure>
<img src={computer_Graph.src} alt="Graph made in Geogebra" width="600" height="auto" />
...
basically USAMO 1974/1. This problem is so common and almost 
...
a fancy notation for a polynomial with integer coefficients) and $m,n \in \mathbb{Z}$. Therefore, its quite obvious 
...
**Personal Remarks:** Personally, I felt this is the hardest problem on the test. 
You definitely need background to solve the problem on the 
test and this is quite a test of your solution writing
skills. I personally saw a solution via Riemann-Sums which 
in my honest opinion is quite clever. I personally found a
completely different solution, which is heavily technical 
to write-up with induction. The good part is, all this is 
well covered in JEE syllabus, but a true test of your proof 
writing skills in exam.
